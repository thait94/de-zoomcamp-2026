...
@click.option('--chunksize', default=100000, type=int, help='Size to process')
def ingest_data(pg_user, pg_pass, pg_host, pg_port, pg_db, table_name, year, month, chunksize):
